...
class ChangePasswordDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { oldPassword: { required: true, type: () => String }, password: { required: true, type: () => String, minLength: 6, maxLength: 20, pattern: "/^(?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\\s).{6,20}$/" }, confirmPassword: { required: true, type: () => String } };
    }
}
