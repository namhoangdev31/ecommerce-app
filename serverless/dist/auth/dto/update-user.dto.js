...
class UpdateUserDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { username: { required: true, type: () => String }, email: { required: true, type: () => String }, name: { required: true, type: () => String }, address: { required: true, type: () => String }, contact: { required: true, type: () => String }, status: { required: true, enum: require("../user-status.enum").UserStatusEnum, enum: statusEnumArray }, roleId: { required: true, type: () => Number } };
    }
}
