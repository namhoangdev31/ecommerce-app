...
class CreatePermissionDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { resource: { required: true, type: () => String, maxLength: 50 }, description: { required: true, type: () => String }, path: { required: true, type: () => String, maxLength: 50 }, method: { required: true, enum: require("../../config/permission-config").MethodList, enum: methodListArray } };
    }
}
